...
class CustomHybridUiTests(unittest.TestCase):
    def test_ui_proxies_unauthenticated_upload_status_report_and_download(self):
        ...
        with TestClient(app) as client:
            ...
            self.assertIn("Checkbox Boxes Added", page.text)
            self.assertIn("Checked Controls", page.text)
            self.assertIn("Unchecked Controls", page.text)
            self.assertIn("Ambiguous Controls", page.text)
            ...
            self.assertIn("Order Status", page.text)
            self.assertIn("Strategy / Mode", page.text)
            self.assertIn("Document Groups", page.text)
            self.assertIn("Group / Order", page.text)
            self.assertIn("Document type:", page.text)
